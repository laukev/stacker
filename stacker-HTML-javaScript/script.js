...
function moveRight(row) {
  row.pop(); //drops last number on the array ( 1, 1, 1, 0, 0)
  row.unshift(0); //insert a new value in the array (0, 1, 1, 1, 0, 0)
}

function moveLeft(row) {
  row.shift(); // removing the first element of the array (0, 0, 1, 1, 1 )
  row.push(0); // adding a new value at the end of the array (0, 0, 1, 1, 1, 0)
}
